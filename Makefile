#############################################################################
# Makefile for building: grow-qt
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  grow-qt.pro
# Template: app
# Command: C:\Qt\5.7_static\bin\qmake.exe "USE_QRCODE=1" "USE_UPNP=1" "USE_IPV6=1" -o Makefile grow-qt.pro
#############################################################################
...
Makefile: grow-qt.pro ../Qt/5.7_static/mkspecs/win32-g++/qmake.conf ../Qt/5.7_static/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) "USE_QRCODE=1" "USE_UPNP=1" "USE_IPV6=1" -o Makefile grow-qt.pro
...
distclean: debug-distclean release-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\grow3\grow-qt_plugin_import.cpp .qmake.stash
