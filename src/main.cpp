...
CBigNum bnProofOfWorkLimit(~uint256(0) >> 20);			// "standard" target limit for proof of work
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // grow: check proof-of-stake block signature
...
// grow: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "grow", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "growth!";
        CTransaction txNew;
        txNew.nTime = 1509661706;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1509661706;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1830171 : 1830171;
...
//        assert(block.hashMerkleRoot == uint256("0x"));
        assert(block.hashMerkleRoot == uint256("0x519e0a72ed809e35f0d113b49241c2ffc9867844bf5bc3f2eb15445c364836dc"));
...
unsigned char pchMessageStart[4] = { 0xc5, 0xc5, 0x1c, 0xee };
