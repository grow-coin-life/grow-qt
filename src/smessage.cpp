...
// Copyright (c) 2014-2015 The grow developers
// Copyright (c) 2015 The grow developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("grow-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("grow-smsg-pow"); // Make this thread recognisable
